...
// Inline form to register a payment to a supplier against one purchase.
  ...
  if (!open) {
    return (
      <button
        ...
        className="mt-3 bg-green-700 px-3 py-1.5 font-bold uppercase tracking-widest text-[11px] text-white"
      >
        Registrar pago
      </button>
    );
