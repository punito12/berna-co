...
const TEXTS: [string, string, number, string][] = [
  ...
  ["catalog.product.breadcrumb_label", "Empanado", 30, "catalogo"],
  ["catalog.product.payment_cash_label", "efectivo", 30, "catalogo"],
  ["catalog.product.payment_transfer_label", "transferencia", 30, "catalogo"],
  ["catalog.product.payment_transfer_short_label", "transf.", 20, "catalogo"],
  ["catalog.product.view_detail_label", "Ver detalle y fotos →", 50, "catalogo"],
  [
  ...
  ["catalog.product.added_label", "Agregado ✓", 40, "catalogo"],
  ["catalog.product.added_detail_label", "Agregado al carrito ✓", 60, "catalogo"],
  [
  ...
  ["catalog.product.out_of_stock_label_detail", "Sin stock", 40, "catalogo"],
  ["catalog.cart.show_label", "Ver carrito", 40, "catalogo"],
  ["catalog.cart.hide_label", "Ocultar carrito", 40, "catalogo"],
  ["catalog.cart.continue_label", "Continuar", 40, "catalogo"],
