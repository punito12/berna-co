...
export const CMS_VISUAL_PAGES: CmsVisualPage[] = [
  ...
  },
  {
    ...
    sections: [
      {
        id: "ingredient.huevos",
        label: "Huevos",
        page: "ingredientes",
        description: "Título, bajada y texto de la página Huevos.",
        marker: "ingredient.huevos",
        previewPath: "/ingredientes/huevos",
        status: "partial",
        groups: ["content"],
        advancedHref: "/admin/editor/ingredientes",
      ...
      {
        id: "ingredient.pollo",
        label: "Pollo Pastoril",
        page: "ingredientes",
        description: "Título, bajada y texto de la página Pollo Pastoril.",
        marker: "ingredient.pollo",
        previewPath: "/ingredientes/pollo-pastoril",
        status: "partial",
        groups: ["content"],
        advancedHref: "/admin/editor/ingredientes",
      },
      {
        id: "ingredient.peceto",
        label: "Peceto de Pastura",
        page: "ingredientes",
        description: "Título, bajada y texto de la página Peceto de Pastura.",
        marker: "ingredient.peceto",
        previewPath: "/ingredientes/peceto-de-pastura",
        status: "partial",
        groups: ["content"],
        advancedHref: "/admin/editor/ingredientes",
      },
